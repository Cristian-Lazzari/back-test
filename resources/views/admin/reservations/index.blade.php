            ...
            <tbody>
                @foreach ($reservations as $reservation)
                    ...
                    >
                        ...
                        {{-- OSPITI  --}}
                        <td>{{ $reservation->n_person }}</td>
    
                        {{-- TELEFONO  --}}
                        <td class="text-truncate d-none d-lg-table-cell">
                            <a class="phone text-decoration-none" href="{{ "https://wa.me/" . '39' . $reservation->phone }}">{{ $reservation->phone }}</a>
                        </td>
    
                        {{-- EMAIL  --}}
                        <td class="text-truncate d-none d-lg-table-cell">{{ $reservation->email }}</td>
